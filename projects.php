<html>
    ...
    echo "<tr><th>PROJECT ID</th><th>TITLE</th><th>CATEGORY</th><th>ABSTRACT</th><th>DONE BY</th><th>CONTACTS</th></tr>";
    while($project = mysqli_fetch_array($results)){
    echo "<tr><td>".$project['ProjectID']."</td><td>".$project['Title']."</td><td>".$project['Category']."</td><td>".$project['Abstract']."</td><td>".$project['Name']."</td><td>".$project['Email']."</td></tr>";
    }
    ...
    echo '<table border="1"  style="text-align:center;background-color:pink">';
    echo "<tr><th>PROJECT ID</th><th>TITLE</th><th>CATEGORY</th><th>ABSTRACT</th><th>SCORE</th><th>DONE BY</th><th>STUDENT'S CONTACTS</th><th>SUPERVISED BY</th><th>SUPERVISOR'S CONTACTS</th></tr>";
    while($project = mysql_fetch_array($results)){
    echo "<tr><td>".$project['PROJECTID']."</td><td>".$project['TITLE']."</td><td>".$project['CATEGORY']."</td><td>".$project['ABSTRACT']."</td><td>".$project['SCORE']."</td><td>".$project['NAME']."</td><td>".$project['CONTACTS']."</td><td>".$project['SUPERVISOR']."</td><td>".$project['SUPERVISOR_CONTACTS']."</td></tr>";
    }
